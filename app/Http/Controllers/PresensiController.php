...
class PresensiController extends Controller
{
        ...
        if ($radius > $lok_kantor->radius) {
            ...
            if ($cek > 0) {
                ...
                if ($update) {
                    ...
                    echo "error|Gagal Melakukan Absensi|out";
                }
            } else {
                $data = [
                    'nik' => $nik,
                ...
                if ($simpan) {
                    echo "success|Absensi Sudah Masuk, Semangat Bekerja|in";
                    Storage::put($file, $image_base64);
                } else {
                    echo "error|Gagal Melakukan Absensi|in";
                }
            }
        }
    }
    ...
    {
        $nik = Auth::guard('employee')->user()->nik;
        $employee = DB::table('employee')->where('nik', $nik)->first();
        return view('presensi.editprofile', compact('employee'));
    }
    ...
    public function ajuanizin()
    {
        return view('presensi.ajuanizin');
    }
    ...
    public function getpresensi(Request $request)
    {
        ...
        $presensi = DB::table('presensi')
            ...
            ->join('employee', 'presensi.nik', '=', 'employee.nik')
            ->join('department', 'employee.kode_dept', '=', 'department.kode_dept')
    ...
    {
        $namabulan = ["", "Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"];
        $karyawan = DB::table('employee')->orderBy('nama_lengkap')->get();
    ...
    public function cetaklaporan(Request $request)
    {
        ...
        $tahun = $request->tahun;
        $namabulan = ["", "Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"];
        $karyawan = DB::table('employee')->where('nik', $nik)
            ->join('department', 'employee.kode_dept', '=', 'department.kode_dept')
            ->first();
    ...
    public function izinsakit(Request $request)
    {
        ...
        $query->join('employee', 'pengajuan_izin.nik', '=', 'employee.nik');
