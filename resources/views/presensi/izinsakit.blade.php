                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="dari" value="{{ Request('dari') }}" class="form-control" name="dari" placeholder="Dari" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="sampai" value="{{ Request('sampai') }}" class="form-control" name="sampai" placeholder="Sampai" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="nik" value="{{ Request('nik') }}" class="form-control" name="nik" placeholder="Nik" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="nama_lengkap" value="{{ Request('nama_lengkap') }}" class="form-control" name="nama_lengkap" placeholder="Nama Karyawan" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="btn btn-sm btn-primary" id="status" id_izinsakit="{{ $d->id }}">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Status Approved</h5>
