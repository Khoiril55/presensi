            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a href="#" class="btn btn-primary" id="btnadddivisi">
                                    ...
                                    <div class="row">
                                        <div class="col-10">
                                            <div class="form-group">
                                                <input type="text" name="nama_dept" id="nama_dept" class="form-control" placeholder="Divisi" value="{{ Request('nama_dept') }}">
                                            </div>
                                        </div>
                                        <div class="col-2">
                                            <div class="form-group">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <form action="/divisi/{{ $d->kode_dept }}/delete" method="POST" style="margin-left:5px">
                                                        @csrf
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="nik" value="" class="form-control" name="kode_dept" placeholder="Kode Divisi">
                            </div>
                        </div>
                    </div>
                    <div class="row">
